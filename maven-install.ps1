...
$envvar = $mavenHome +"\apache-maven-3.8.4"
...
[Environment]::SetEnvironmentVariable("MAVEN_HOME", $envvar, "Machine")
[Environment]::SetEnvironmentVariable("Path", "$($env:Path);$envvar\bin", "Machine")
